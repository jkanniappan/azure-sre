...
1. Download the **/Allfiles/Labs/03/03-vm-template-uniq.json** lab files to your computer.
...
1. Locate and select the **/Allfiles/Labs/03/03-vm-template-uniq.json** file and select **Open**.
